...
import NfcPassportReader, { type NfcResult } from 'react-native-nfc-passport-reader';
...
export default function App() {
  ...
  const startReading = () => {
    NfcPassportReader.startReading({
      bacKey: {
        documentNo: 'A40C05995', // Document Number
        expiryDate: '2032-12-24', // YYYY-MM-DD
        birthDate: '1999-06-01', // YYYY-MM-DD
      },
      ...
      {tagDiscovered && (
        <View style={styles.overlayBox}>
          <View style={styles.infoBox}>
            <Text style={styles.infoText}>NFC reading. Please wait for a moment...</Text>
          </View>
        </View>
      )}
    </SafeAreaView>
