...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      className={cn(
        'native:h-10 native:px-5 native:py-0 web:focus:bg-accent active:bg-accent web:focus:text-accent-foreground flex flex-row items-center rounded-sm px-3 py-1.5 text-sm font-medium web:cursor-default web:select-none web:outline-none',
  ...
  return (
    <TextClassContext.Provider
      ...
      <MenubarPrimitive.SubTrigger
        className={cn(
          'web:focus:bg-accent active:bg-accent web:hover:bg-accent native:py-2 flex flex-row items-center gap-2 rounded-sm px-2 py-1.5 web:cursor-default web:select-none web:outline-none',
          open && 'bg-accent',
          inset && 'pl-8',
          className
        )}
